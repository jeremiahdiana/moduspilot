  ...
  return (
    <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ duration: 0.4 }}
      ...
      <div className="px-4 py-3 flex items-center gap-2 bg-brand/[0.07]">
        ...
        <span className="text-xs font-semibold text-muted uppercase tracking-wider">Action set ready</span>
      </div>
    ...
    { type: 'card', delay: 2600, component: (
      <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ duration: 0.4 }}
        ...
        <div className="px-4 py-3 bg-brand/[0.07]">
          <span className="text-xs font-semibold text-muted uppercase tracking-wider">Goal plan · $10k this month</span>
        </div>
  ...
  inbox: [
    ...
    { type: 'card', delay: 2800, component: (
      <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ duration: 0.4 }}
        className="bg-panel rounded-2xl overflow-hidden shadow-lg shadow-black/25 ring-1 ring-brand/20">
        <div className="px-4 py-3 bg-brand/[0.07]">
          <p className="text-xs font-semibold text-muted uppercase tracking-wider">Needs your reply today (3)</p>
        </div>
        {[
  ...
  memory: [
    ...
    { type: 'card', delay: 1200, component: (
      <motion.div variants={fadeUp} initial="hidden" animate="show" transition={{ duration: 0.4 }}
        ...
        <div className="px-4 py-3 bg-brand/[0.07]">
          <span className="text-xs font-semibold text-muted uppercase tracking-wider">Memory · 3 weeks ago</span>
        </div>
...
function ScenariosSection() {
  ...
  return (
    <section className="px-6 py-20 max-w-5xl mx-auto" ref={ref}>
      <RevealOnScroll>
        <p className="text-xs font-bold text-muted uppercase tracking-widest mb-3">Live scenarios</p>
      ...
      <div className="relative pt-24" style={{ zIndex: 2 }}>
        ...
        <section className="px-6 py-20 max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: [0.16,1,0.3,1] }}>
            <p className="text-xs font-bold text-muted uppercase tracking-widest mb-4">Features</p>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold text-text leading-[1.08] mb-8 tracking-tight">
              ...
              <span className="text-text">One that knows you.</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              {['Every frontier model', 'Reads your email & calendar', 'Makes images, charts, docs', 'Acts with your approval', 'One $24 bill'].map(tag => (
                <span key={tag} className="text-xs font-medium text-text/80 bg-text/[0.06] px-3 py-1.5 rounded-full">
                  {tag}
                </span>
              ))}
            </div>
        ...
        <section className="px-6 py-20 max-w-5xl mx-auto">
          <RevealOnScroll>
            <p className="text-xs font-bold text-muted uppercase tracking-widest mb-3">Every model</p>
        ...
        <section className="px-6 py-20 max-w-5xl mx-auto">
          <RevealOnScroll>
            <p className="text-xs font-bold text-muted uppercase tracking-widest mb-3">The difference</p>
            <h2 className="text-4xl font-semibold text-text mb-4">They give you one company&apos;s AI.<br />
              <span className="text-text">MODUS gives you everyone&apos;s.</span>
            </h2>
        ...
        <section className="px-6 py-24 text-center relative overflow-hidden">
          ...
          <RevealOnScroll direction="none">
            <div className="relative max-w-2xl mx-auto space-y-6">
              <p className="text-xs font-bold text-muted uppercase tracking-widest">Ready?</p>
              <h2 className="text-4xl md:text-5xl font-semibold text-text leading-tight">
                You&apos;re the executive.<br />
                <span className="text-text">MODUS handles the rest.</span>
              </h2>
              <p className="text-muted text-lg leading-relaxed">
