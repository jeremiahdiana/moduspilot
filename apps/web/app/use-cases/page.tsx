  ...
  return (
    <MarketingShell>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-10">
        {CASES.map(uc => (
          <section key={uc.title} className="py-12 border-t border-border">
            <div className="grid md:grid-cols-[260px_1fr] gap-8 md:gap-12">
              <div className="md:sticky md:top-24 self-start">
                ...
                <p className="text-sm text-muted leading-relaxed">{uc.blurb}</p>
              </div>
              <ul className="grid sm:grid-cols-2 gap-x-8 gap-y-4 self-start">
                {uc.workflows.map(w => (
