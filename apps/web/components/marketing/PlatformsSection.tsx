...
const PLATFORMS = [
  {
    ...
    desc: 'Every frontier model, your goals, habits, tasks, and morning briefing in one place. Open a tab and start — nothing to install, on any machine you sit down at.',
    detail: 'One account, synced everywhere in real time',
